...
function Notice() {
    return (
        <>
            <div className="position-relative d-none d-xxl-block" style={{ width: '35%', left: '12%', transform: 'rotate(-2deg)' }}>
            ...
            <div className="position-relative d-none d-xl-block d-xxl-none" style={{ width: '41%', left: '6%', transform: 'rotate(-2deg)' }}>
                <p className="fs-1 text-start text-white m-0">オシラセ</p>
                <div style={{ border: '3px solid #e20c13', maxWidth: '675px' }}>
                    <div className="m-4">
                        <div className="overflow-auto" style={{ height: '690px', }}>
            ...
            <div className="position-relative d-none d-lg-block d-xl-none" style={{ width: '44%', left: '4%', transform: 'rotate(-2deg)' }}>
                <p className="fs-1 text-start text-white m-0">オシラセ</p>
                <div style={{ border: '3px solid #e20c13', maxWidth: '675px' }}>
                    <div className="m-4">
                        <div className="overflow-auto" style={{ height: '690px', }}>
            ...
            <div className="position-relative d-none d-md-block  d-lg-none" style={{ width: '47%', left: '2%',  }}>
